...
def get_coxs2v(split, batch_size=50):
    ...
    if split == "train":
        coxs2v_dataset = datasets.ImageFolder("/export/livia/data/lemoineh/COX-S2V/test_ouput2/video2",
                                          transform=pre_process)

    elif split == "val":
        coxs2v_dataset = datasets.ImageFolder("/export/livia/data/lemoineh/COX-S2V/test_ouput2/video1",
                                              transform=pre_process)
